...
//    std::shared_ptr<RayTracer::IShape> sphere = factory.createPrimitive("sphere", point3(0.0, 0.0, -1.0), 0.5, material);
//    std::shared_ptr<RayTracer::IShape> sphere = factory.createComponent("primitive_sphere", "sphere");
